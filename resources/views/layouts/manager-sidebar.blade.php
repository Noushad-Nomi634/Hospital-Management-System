        ...
        <ul class="metismenu" id="sidenav">
            ...
            <li>
                ...
                <ul>
                    ...
                    <li><a href="{{ url('/employees/salaries') }}"><i class="material-icons-outlined">attach_money</i> Salaries</a></li>
                </ul>
            </li>
            ...
            <li>
                ...
                <ul>
                    <li><a href="{{ url('/expenses/types') }}"><i class="material-icons-outlined">category</i> Expense Types</a></li>
            ...
            <li>
                ...
                <ul>
                    ...
                    <li><a href="{{ url('/users') }}"><i class="material-icons-outlined">group</i> Users</a></li>
                </ul>
            </li>
            ...
            <li>
                ...
                <ul>
                    ...
                    <li><a href="{{ url('/income-report') }}"><i class="material-icons-outlined">list_alt</i> All Transaction</a></li>
                </ul>
            </li>
